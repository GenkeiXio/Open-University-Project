...
<head>
    <meta charset="UTF-8">
    <title>@yield('title', 'Staff Portal') | BUOU</title>
...
<body class="bg-gray-100 dark:bg-[#0b1120] text-gray-800 dark:text-gray-200 transition-colors duration-300">
        ...
        <aside id="sidebar"
            ...
            <button id="toggleSidebar"
                class="hidden md:flex absolute -right-3 top-[72px]
                       ...
                       shadow-md hover:bg-violet-50 dark:hover:bg-violet-900
                       transition z-50">
            ...
            <div class="flex items-center gap-3 px-5 py-5 border-b border-gray-100 dark:border-gray-800">
                <div class="logo-icon w-9 h-9 rounded-xl bg-violet-600 text-white
                ...
                <div class="logo-text sidebar-text">
                    ...
                    <span class="block text-[10px] text-gray-400 uppercase tracking-widest">Staff Portal</span>
                </div>
            </div>
            ...
            <nav class="flex-1 px-3 py-4 overflow-y-auto space-y-1">
                ...
                <p class="sidebar-section-label sidebar-text text-[10px] text-gray-400 uppercase
                           tracking-widest font-semibold px-2 pb-1.5">Staff</p>
                ...
                <div>
                    <button id="requestsToggle" data-label="Requests"
                        class="menu-item w-full flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm
                               ...
                               {{ request()->routeIs('staff.requests*') ? 'active' : 'text-gray-600 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800' }}">
                    ...
                    <div id="requestsSubmenu"
                        ...
                        <a href="{{ route('staff.requests.index') }}" data-label="All Requests"
                            class="menu-item flex items-center gap-3 px-3 py-2 rounded-xl text-sm
                                   transition-all duration-150
                                   {{ request()->routeIs('staff.requests.index') ? 'active' : 'text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800' }}">
                            <i data-lucide="layers" class="w-3.5 h-3.5 flex-shrink-0"></i>
                            <span class="sidebar-text">All Requests</span>
                        </a>

                        <a href="#" data-label="My Assigned"
                            class="menu-item flex items-center gap-3 px-3 py-2 rounded-xl text-sm
                                   transition-all duration-150
                                   {{ request()->routeIs('staff.requests.assigned') ? 'active' : 'text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800' }}">
                            <i data-lucide="user-check" class="w-3.5 h-3.5 flex-shrink-0"></i>
                ...
                {{-- Thesis & Dissertation (collapsible) --}}
                <div>
                    <button id="thesisToggle" data-label="Thesis & Dissertation"
                        class="menu-item w-full flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm
                               transition-all duration-150
                    ...
                    <div id="thesisSubmenu"
                        ...
                        <a href="#" data-label="Defense Schedule"
                            ...
                            <span class="sidebar-text">Defense Schedule</span>
                        </a>
    ...
    <script>
        ...
        requestsToggle.addEventListener('click', () => {
            ...
            requestsToggle.querySelector('.chevron').classList.toggle('open', !isOpen);
        });
        ...
        thesisToggle.addEventListener('click', () => {
            ...
            thesisSubmenu.classList.toggle('open', !isOpen);
