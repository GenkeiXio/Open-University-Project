    ...
    <div class="container-fluid position-relative px-0" style="margin-top: 90px; padding-top: 20px;">
        <div class="row g-0">
            ...
            <div class="col-lg-6 px-lg-5 pt-2 pb-5">
                ...
                <div class="tab-content" id="buouTabContent">
                    ...
                    <div class="tab-pane fade" id="about-section" role="tabpanel" aria-labelledby="about-tab">
                        <section id="about" class="about-section py-4 bg-white">
                    ...
                    <div class="tab-pane fade" id="programs-section" role="tabpanel" aria-labelledby="programs-tab">
                        <section id="programs" class="about-section py-4 bg-white">
                            ...
                            <div class="row justify-content-center">
                                <div class="col-lg-12"> 
                                    @foreach($faculties as $faculty)
                                        <div class="row align-items-center faculty-card gy-4 mb-4 border-0 shadow-sm rounded-4 p-4 mx-0">
                                            <div class="col-md-4">
                            ...
                            <div class="news-accordion-container mx-auto" id="newsAccordion"> 
                                ...
                                <div class="news-custom-item mb-2">
                                    ...
                                    <div id="news-collapse-graduates" class="collapse" data-bs-parent="#newsAccordion">
                                        <div class="news-body py-4 text-muted text-justify">
                                            <p>
                                                The Bicol University Open University extends its warmest congratulations to the graduating class of 2025. Your unwavering commitment to your studies, despite the challenges of pursuing education through a non-traditional format, is a testament to your resilience and dedication.
                                            </p>
                                            <p>
                                                This accomplishment reflects not only your individual efforts but also the supportive environment fostered by the BUOU community. We are immensely proud of your achievements and the contributions you will undoubtedly make to your communities and the wider world.
                                            </p>
                                            <p>
                                                As you embark on new endeavors, may this graduation mark the beginning of a fulfilling and successful future. The Bicol University Open University remains committed to supporting your continued growth and development.
                                            </p>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="tab-pane fade" id="contacts-section" role="tabpanel" aria-labelledby="contacts-tab">
                        <section id="contacts" class="contact-page-section pt-0 pb-5 bg-white">
                            <div class="contact-wrapper mx-auto about-accordion"> 
                                <h2 class="fw-bold mb-4 mt-0 text-uppercase" style="letter-spacing: 1px; color: #333;">Contact Information</h2>
                    ...
                    <div class="tab-pane fade" id="faqs-section" role="tabpanel" aria-labelledby="faqs-tab">
                        <section id="faqs" class="buou-faq-section pt-0 pb-5 bg-white">
                            <div class="row mb-4 justify-content-center text-center">
                                <div class="col-lg-12">
                                    
                                    <h2 class="buou-faq-main-title mt-0">Frequently Asked Questions</h2>
            ...
            <div class="ai-chatbot">
                <div class="chat-toggle shadow-lg" id="chatToggle" style="background-color: #176d86; transition: transform 0.3s ease;">
                    <i data-lucide="message-circle" style="color: white;"></i>
                </div>

                <div class="chat-box shadow-2xl" id="chatBox" style="border: 1px solid rgba(0,0,0,0.1); border-radius: 16px;">
                    <div class="chat-header" style="background: linear-gradient(160deg, #1f8aa5 0%, #176d86 100%);">
                        <div class="chat-title">
                            <div class="chat-avatar" style="background: rgba(255,255,255,0.2); font-weight: 800;">BU</div>
                            <div>
                                <strong style="font-family: 'Raleway', sans-serif;">BUOU Assistant</strong>
                                <p style="font-size: 0.75rem; opacity: 0.9; margin: 0;">Online | Ready to help</p>
                            </div>
                        </div>
                        <button class="chat-close" id="chatClose">✕</button>
                    </div>

                    <div class="chat-body" style="background-color: #f8f9fa;">
                        <div class="chat-message bot shadow-sm" style="border-radius: 15px 15px 15px 2px; font-family: 'Raleway', sans-serif;">
                    ...
                    <div class="chat-input p-3" style="background: white;">
                        <input type="text" class="form-control border-0 bg-light" placeholder="Type your question..." style="font-size: 0.9rem; border-radius: 8px;" />
                        <button class="btn ms-2" style="background-color: #ea6a0e; color: white; border-radius: 8px;">
                            ➤
                        </button>
                    </div>
                </div>
