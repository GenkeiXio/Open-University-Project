...
<div class="max-w-7xl mx-auto">
    <div class="flex justify-between items-center mb-10">
        ...
        <div class="flex justify-between items-center mb-8">
            ...
            <button onclick="toggleSidebar()" class="md:hidden p-2 rounded bg-gray-200 dark:bg-gray-700">
                <i data-lucide="menu"></i>
            </button>

            <button id="themeToggle" class="p-2 rounded bg-gray-200 dark:bg-gray-700 hover:scale-105 transition">
